package com.example.language_app.ui.screens.profile
...
@Composable
fun ProfileScreen(navActions: AppNavigation) {
    Scaffold(
...
fun ProfileScreenPreview() {
    ProfileScreen(navActions = AppNavigation(rememberNavController()))
}